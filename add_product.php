            ...
            if(isset($_POST["submit"])) {
                ...
                if ($uploadOk == 0) {
                    ...
                    if (move_uploaded_file($_FILES["fileToUpload"]["tmp_name"], $target_file)) {
                        ...
                        $result2=mysqli_query($conn,"INSERT INTO product(Product_Name, Category, Price, Description, Image_URL) values('$name','$category',$price,'$description','$target_file');")or die("Could not read table");
                        if($result2){
